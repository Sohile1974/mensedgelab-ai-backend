...
def evaluate_photo():
    try:
        ...
        # Step 2 (Final Report with Clean Formatting)
        step2_prompt = f"""
You are a professional AI fitness coach. Write a structured HTML report inside <div style='font-family: Arial, sans-serif; font-size: 14px; line-height: 1.6;'>...</div>. Use only <strong>, <ul>, <li>, and <br>. Avoid markdown.
Your tone is strict but motivational. Do not repeat the user prompt. Begin immediately after the div tag.
...
Assign a score between 0–100 based on visible fat, posture, symmetry, muscle definition, and BMI. Be strict but fair. Then justify the score in 2 sentences.<br><br>
