...
"""
        ...
        pdfkit.from_string(final_report, filepath)

        return jsonify({"pdf_url": f"/download/{filename}"})
...
def download_file(filename):
    return send_file(os.path.join("/mnt/data", filename), as_attachment=True)
